...
a. [This](https://open.spotify.com/playlist/1iFmLHToftfdYVq9FUpoKI?si=0bbd0df395ad4628) is my "upbeat chill" playlist. It contains $n = 15$ songs. There are 12 artists with one song apiece and Childish Gambino has $k=3$ songs. Shuffle this playlist at least twenty times[^1] and compute the proportion of the time the shuffle contained a "Childish Gambino streak." Using the previous part, compare this empirical proportion to the theoretical probability that would prevail if the shuffle was truly random.
