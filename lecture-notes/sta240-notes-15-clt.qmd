...
In addition to the examples above, you also saw an example of this style of convergence on the last problem set.
...
$$
\begin{aligned}
M_{Z_n}(t)=\prod_{i=1}^nM_{X_i}(t/\sqrt{n})=\prod_{i=1}^nM(t/\sqrt{n}) =
[M(t/\sqrt{n})]^n.
\end{aligned}
$$
...
$$
\begin{aligned}
M(0)&=\mathbb E\left[e^{0\cdot X_1}\right]=1 && \text{always true}\\
M'(0)&=\mathbb E[X_1]=0 && \text{assumption from above}\\
M''(0)&=\mathbb E[X_1^2]=\text{var}(X_1)+\mathbb E[X_1]^2=1+0=1 && \text{assumption from above}.
\end{aligned}
$$
