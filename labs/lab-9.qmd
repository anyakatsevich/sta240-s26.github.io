---
title: "Lab 9"
subtitle: Due Thursday April 2 at 11:59 PM
format: html
draft: false
editor: 
  mode: source
...
What if we want to find the marginal expectation of a random variable, but we only have access to its *conditional* relationships? Per a neat little thing called the **tower property**, we have the following: For random variables $X$ and $Y$, $$\mathbb{E}[X] = \mathbb{E}\left[\mathbb{E}[X \mid Y]\right].$$ Cool! Proof available on demand.
