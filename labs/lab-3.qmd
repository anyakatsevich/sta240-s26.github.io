---
title: "Lab 3"
subtitle: Due Thursday January 29 at 11:59 PM
draft: false
editor: 
  mode: source
---
...
In order to do next week's lab, regardless of whether you're using the containers or your local RStudio, you will need to install the `kgrams` package. Copy the following code into your console and run it:
...
Let the teaching team know if you have any difficulties with the installation, so we can help troubleshoot before the lab!
