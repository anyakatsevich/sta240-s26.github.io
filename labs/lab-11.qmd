---
title: "Lab 11"
subtitle: Due Thursday April 16 at 11:59 PM
format: html
filters:
  - shinylive
---
...
Let $a, b \in \mathbb{R}$. A **convex combination** (or **weighted average**) of $a$ and $b$ is a linear combination of the form $$w \cdot a + (1 - w) \cdot b,$$ where $w \geq 0$. Necessarily, then, the weights $w$ and $(1 - w)$ sum to $1$.
